...
--deleted default = true from this line hl.workspace_rule({ workspace = "name:gaming", monitor = PRIMARY_MONITOR,  })
...
hl.workspace_rule({ workspace = "9",  monitor = MONITOR1, persistent = true })
...
--hl.workspace_rule({ workspace = "17",  monitor = MONITOR2, persistent = true })
--hl.workspace_rule({ workspace = "18",  monitor = MONITOR2, persistent = true })
--hl.workspace_rule({ workspace = "19",  monitor = MONITOR2, persistent = true })
--hl.workspace_rule({ workspace = "20", monitor = MONITOR2, persistent = true })