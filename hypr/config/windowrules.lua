...
hl.window_rule({match = { class = "^(.*satty.*)$" },size = { "monitor_w*0.5", "monitor_h*0.5" },float = true})
...
hl.window_rule({ match = { class = "^(firefox|zen)$" }, opacity = "0.85 override" })
...
hl.window_rule({ match = { class = "^(obsidian)$" }, opacity = "0.5 override 0.5 override" , no_blur = true})
